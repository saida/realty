...
=begin    
    images.each do |image|
      if image.image?
        ...
        _landmark_old = Russian.translit(landmark_was.to_s.force_encoding('utf-8'))
        _landmark = Russian.translit(landmark.to_s.force_encoding('utf-8'))
        ...
        old_path = Rails.root.join('public', 'photos', _district, info_old)
